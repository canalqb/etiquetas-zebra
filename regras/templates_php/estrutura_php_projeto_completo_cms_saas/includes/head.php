...
$pageTitle = $pageTitle ?? cms_get_setting('site_name');

// {{cms_page_description}} - Variável de descrição da página
$pageDescription = $pageDescription ?? cms_get_setting('default_description', 'Painel administrativo do CMS');

// {{cms_page_keywords}} - Variável de palavras-chave
$pageKeywords = $pageKeywords ?? cms_get_setting('default_keywords', 'cms, admin, painel');
